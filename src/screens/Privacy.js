        ...
        <View style={{ backgroundColor: COLORS.background }}>
            <View style={{ height: '100%', width: '100%', backgroundColor: COLORS.background, transform: [{ rotate: '90deg' }] }}>
                <View style={{ marginTop: 40, marginLeft: 16, marginRight: 16, alignSelf: 'center' }}>
                    <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 24, bottom: 190 }}>Privacy & Policy </Text>
                </View>
                <ScrollView>
                    ...
                    <View style={{ backgroundColor: 'white', elevation: 4, marginTop: 50, borderRadius: 15, width: '50%', alignSelf: 'center' }}>
                        ...
                        <View style={{ marginBottom: 100, marginTop: 25 }}>
                            <Text style={styles.content}>Basic Purpose:
                                At postmyad.ai, we believe you should always know what data we collect from you and how we use it, and that you should have meaningful control over both. We want to empower you to make the best decisions about the information that you share with us.
                            ...
                            <Text style={styles.content2}>1.	postmyad.ai is a public domain and its content is immediately viewable and searchable by anyone around the world. You can also use postmyad.ai under a pseudonym if you prefer not to use your name.
                                2.	When you use postmyad.ai, even if you’re just looking at content, we receive some personal information from you like your profile, the type of device you’re using and your IP address. You can choose to share additional information with us like your address book contacts and/or a public profile. We use this information for things like keeping your account secure and showing you more relevant content and ads, etc.
                                3.	We give you control through your settings to limit the data we collect from you and how we use it, and to control things like account security, marketing preferences and address book contacts you’ve uploaded to postmyad.ai. You can also download information you have shared on postmyad.ai.
                            ...
                            <Text style={styles.content3}>I.	Information You Share With Us
                                We require certain information to provide our services to you. For instance, you must have an account in order to upload or share content on postmyad.ai. When you choose to share the below information with us, we collect and use it to operate our services.</Text>
                            <Text style={styles.content4}>a.	Basic Account Information
                                You have to create an account to use our services. If you do choose to create an account, you must provide us with some personal data so that we can provide our services to you. On postmyad.ai this includes a display name, a username (for example, @postmyad.ai Influencer), a password, and an email address or phone number. Your display name and username are always public, but you can use either your real name or a pseudonym. If you choose to create a professional account, you must also provide us with your professional category, and may provide us with additional information, including street address, contact email address, and contact phone number, all of which will always be public. In case you transact on our platform, you will have to provide Tax IDs and Goods and Service Tax IDs for regulatory and statutory compliances. You can also create and manage multiple postmyad.ai accounts for example to provide different types of content.

                                b.	Public Information
                                Most activity on postmyad.ai is public, including your profile information, your display language, when you created your account, and your content and certain information about your Content like the date, time, and application and version of postmyad.ai you are using. When you share audio or visual content on our service we may analyze that data to operate our services, for example by providing audio transcription. The lists you create, people you follow and who follow you, and Content you Like are also public. If you like, respond to or otherwise publicly engage with an ad on our services, that advertiser might thereby learn information about you associated with the ad with which you engaged such as characteristics of the audience the ad was intended to reach. Broadcasts you create are public along with when you created them. Your engagement with broadcasts, including viewing, listening, commenting, speaking, reacting to, or otherwise participating in them, on postmyad.ai, is public along with when you took those actions. Any engagement with another account’s broadcast will remain part of that broadcast for as long as it remains on our services. Information posted about you by other people who use our services may also be public.



                                You are responsible for your content and other information you provide through our services, and you should think carefully about what you make public, especially if it is sensitive information. If you update your public information on postmyad.ai, such as by deleting Content or deactivating your account, we will reflect your updated content on postmyad.ai., postmyad.ai for iOS, and postmyad.ai for Android.
                                By publicly posting content, you are directing us to disclose that information as broadly as possible, including through our APIs, and directing those accessing the information through our APIs to do the same. To facilitate the fast global dissemination of Content to people around the world, we use technology like  application programming interfaces (APIs) and embeds to make that information available to websites, apps, and others for their use - for example, displaying Content on a news website or analyzing what people say on postmyad.ai. We generally make this content available in limited quantities for free and charge licensing fees for large-scale access. We have standard terms that govern how this data can be used, and a compliance program to enforce these terms. But these individuals and companies are not affiliated with postmyad.ai, and their offerings may not reflect updates you make on postmyad.ai.

                                c.	Contact Information and Address Books
                                We use your contact information, such as your email address or phone number, to authenticate your account and keep it - and our services - secure, and to help prevent spam, fraud, and abuse. Subject to your settings, we also use contact information to enable certain account features (for example, for login verification), to send you information about our services, and to personalize our services, including ads. If you provide us with your phone number, you agree to receive text messages from postmyad.ai to that number as your country’s laws allow. postmyad.ai also uses your contact information to market to you as your country’s laws allow, and to help others find your account if your settings permit, including through third- party services and client applications. You can use your settings for email and mobile notifications to control notifications you receive from postmyad.ai. You can also unsubscribe from a notification by following the instructions contained within the notification or here.
                                You can choose to upload and sync your address book on postmyad.ai so that we can help you find and connect with people you know and help others find and connect with you. We also use this information to better recommend content to you and others.
                                ...
                                We provide certain features that may let you communicate more privately or control who sees your content. For example, you can use Direct Messages in future to have non-public conversations on postmyad.ai. When you communicate with others by sending or receiving Direct Messages, we will store and process your communications and information related to them. This includes link scanning for malicious content, link shortening to http://t.co URLs, detection of spam, abuse and prohibited images, and use of reported issues. We also use information about whom you have communicated with and when (but not the content of those communications) to better understand the use of our services, to protect the safety and integrity of our platform, and to show more relevant content. We share the content of your Direct Messages with the people you’ve sent them to; we do not use them to serve you ads. When you use features like Direct Messages to communicate, remember that recipients have their own copy of your communications on postmyad.ai - even if you delete your copy of those messages from your account - which they may duplicate, store, or re-share.


                                e.	Payment Information
                                You may provide us with payment information, including your credit or debit card number, card expiration date, CVV code, and billing address, in order to purchase advertising or other offerings provided as part of our services. If you make a payment or send money using postmyad.ai features or services, including through an intermediary, we may receive information about your transaction such as when it was made or when a subscription is set to expire or auto-renew.
                                ...
                                e.	postmyad.ai for Web Data
                                When you view our content on third-party websites that integrate postmyad.ai content such as embedded timelines or content screens, we may receive Log Data that includes the web page you visited. We use this information to better understand the use of our services, to protect the safety and integrity of our platform, and to show more relevant content, including ads. We do not associate this web browsing history with your name, email address, phone number, or username, and we delete, obfuscate, or aggregate it after no longer than 150 days.

                                f.	Advertisers and Other Ad Partners
                                Advertising revenue allows us to support and improve our services. We use the information described in this Privacy Policy to help make our advertising more relevant to you, to measure its effectiveness, and to help recognize your devices to serve you ads on and off of postmyad.ai. Our ad partners and affiliates share information with us such as browser cookie IDs, mobile device IDs, hashed email addresses, demographic or interest data, and content viewed or actions taken on a website or app. Some of our ad partners, particularly our advertisers, also enable us to collect similar information directly from their website or app by integrating our advertising technology. Information shared by ad partners and affiliates or collected by postmyad.ai from the websites and apps of ad partners and affiliates may be combined with the other information you share with postmyad.ai and that postmyad.ai receives about you described elsewhere in our Privacy Policy.

                                g.	Other Third Parties and Affiliates
                                We may receive information about you from third parties who are not our ad partners, such as others on postmyad.ai, partners who help us evaluate the safety and quality of content on our platform, our corporate affiliates, and other services you link to your postmyad.ai account.
                                You may choose to connect your postmyad.ai account to accounts on another service, and that other service may send us information about your account on that service. We use the information we receive to provide you features like cross-posting or cross-service authentication, and to operate our services. For integrations that postmyad.ai formally supports, you may revoke this permission at any time from your application settings; for other integrations, please visit the other service you have connected to postmyad.ai.



                                h.	Personalizing Based On Your Inferred Identity
                                When you log into postmyad.ai on a browser or device, we will associate that browser or device with your account for purposes such as authentication, security, and personalization. Subject to your settings, we may also associate your account with browsers or devices other than those you use to log into postmyad.ai (or associate your logged-out device or browser with other browsers or devices). When you provide other information to postmyad.ai, including an email address, we associate that information with your postmyad.ai account. Subject to your settings, we may also use this information in order to infer other information about your identity, for example by associating your account with hashes of email addresses that share common components with the email address you have provided to postmyad.ai. We do this to operate and personalize our services. For example, if you visit websites with sports content on your laptop, we may show you sports-related ads on postmyad.ai for Android and, if the email address associated with your account shares components with another email address, such as shared first name, last name, or initials, we may later match advertisements to you from advertisers that were trying to reach email addresses containing those components.
                                ...
                                As noted above, postmyad.ai is designed to broadly and instantly disseminate information you share publicly through our services. In the limited circumstances where we disclose your private personal data, we do so subject to your control, because it’s important for operating our services, or because it’s required by law.

                                a.	Sharing You Control
                                We share or disclose your personal data with your consent or at your direction, such as when you authorize a third-party web client or application to access your account or when you direct us to share your feedback with a business. Similarly, to improve your experience, we work with third-party partners to display their video content on postmyad.ai. When you watch or otherwise interact with content from these partners, they may receive and process your personal data as described in their privacy policies.
                                If you do not want this content to play automatically, you can adjust your auto play settings. If you’ve shared information like Direct Messages or protected Content with someone else who accesses postmyad.ai through a third-party service, keep in mind that the information may be shared with the third-party service.
                                Subject to your settings, we also provide certain third parties with personal data to help us offer or operate our services. You can learn more about these partnerships in our Help Center, and you can control whether postmyad.ai shares your personal data in this way by using the “Allow additional information sharing with business partners” option in your Personalization and Data settings. (This setting does not control sharing described elsewhere in our Privacy Policy, such as when we share data with our service providers or through partnerships other than as described in our Help Center)
                                ...
                                We may revise this Privacy Policy from time to time. The most current version of the policy will govern our processing of your personal data and will always be at https://postmyad.ai.com/privacy. If we make a change to this policy that, in our sole discretion, is material, we will notify you within postmyad.ai.com, postmyad.ai for iOS, or postmyad.ai for Android, via a postmyad.ai owned and operated postmyad.ai account (for example @postmyad.aiSupport), or by sending an email to the email address associated with your account. By continuing to access or use the Services after those changes become effective, you agree to be bound by the revised Privacy Policy.
                                ...
                                •	Whether you will be able to receive Direct Messages from anyone on postmyad.ai or just your followers
                                •	Whether others can find you based on your email or phone number
                                •	Whether you upload your address book to postmyad.ai for storage and use
                                •	When and where you may see sensitive content on postmyad.ai
                                •	Whether you want to block or mute other postmyad.ai accounts
                            </Text>
                        </View>
                    </View>
                </ScrollView>
